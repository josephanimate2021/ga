...
module.exports = function (req, res, url) {
  ...
  switch (url.pathname) {
    case "/dashboard/videos": {
	    ...
	    res.end(`<object data="${aniSwfUrl}/player.swf" type="application/x-shockwave-flash" id="video_player"><param name="flashvars" value="apiserver=/&storePath=${aniStoreUrl}/<store>&clientThemePath=${aniClientUrl}/<client_theme>&movieId=${url.query.movieId || ""}&ut=60&appCode=go&page=&siteId=go&m_mode=school&isLogin=Y&isEmbed=1&ctc=go&tlang=en_US&autostart=1"><param name="allowScriptAccess" value="always"></object>`);
	    break;
    } case "/charcreator": {
